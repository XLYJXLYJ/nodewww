...
function Tip(str, pos, callback)
 {
    ...
    switch (pos)
    {
        ...
        '<div style="padding-left:20px;padding-top:40px;"><div style=\'float:left;width:47px;height:46px;background:url("' + rooturl + '/Public/images/pic.jpg") 0px 0px no-repeat \'></div><div id="TipMsg" style="margin-top:10px;height:46px;font-weight:bold;font-size:16px;float:left;margin-left:2px;">' + str + '</div></div>';
        break;
        case 2:
        tip.innerHTML = '<div  align="left" id="TipTop" style="height:20px; background-color:#f7f7fa;"><span style="float:left;margin-left:4px;margin-top:2px;display:inline-block;font-family:Tahoma;font-size:12px;color:#666;"><b>友情提示</b></span><img id="im" style="float:right;margin-top:4px;margin-right:4px;cursor:pointer" src="' + rooturl + '/Public/images/close.jpg"></div>' + 
        '<div style="padding-left:20px;padding-top:40px;"><div style=\'float:left;width:47px;height:46px;background:url("' + rooturl + '/Public/images/pic.jpg") -47px 0px no-repeat \'></div><div id="TipMsg" style="margin-top:10px;height:46px;font-weight:bold;font-size:16px;float:left;margin-left:2px;">' + str + '</div></div>';
        break;
        case 3:
        tip.innerHTML = '<div  align="left" id="TipTop" style="height:20px; background-color:#f7f7fa;"><span style="float:left;margin-left:4px;margin-top:2px;display:inline-block;font-family:Tahoma;font-size:12px;color:#666;"><b>友情提示</b></span><img id="im" style="float:right;margin-top:4px;margin-right:4px;cursor:pointer" src="' + rooturl + '/Public/images/close.jpg"></div>' + 
        '<div style="padding-left:20px;padding-top:40px;"><div style=\'float:left;width:47px;height:46px;background:url("' + rooturl + '/Public/images/pic.jpg") -94px 0px no-repeat \'></div><div id="TipMsg" style="margin-top:10px;height:46px;font-weight:bold;font-size:16px;float:left;margin-left:2px;">' + str + '</div></div>';
        break;
        case 4:
        tip.innerHTML = '<div  align="left" id="TipTop" style="height:20px; background-color:#f7f7fa;"><span style="float:left;margin-left:4px;margin-top:2px;display:inline-block;font-family:Tahoma;font-size:12px;color:#666;"><b>友情提示</b></span><img id="im" style="float:right;margin-top:4px;margin-right:4px;cursor:pointer" src="' + rooturl + '/Public/images/close.jpg"></div>' + 
        '<div style="padding-left:20px;padding-top:40px;"><div style=\'float:left;width:47px;height:46px;background:url("' + rooturl + '/Public/images/pic.jpg") -141px 0px no-repeat \'></div><div id="TipMsg" style="margin-top:10px;height:46px;font-weight:bold;font-size:16px;float:left;margin-left:2px;">' + str + '</div></div>';
        break;
    }
