...
web_editor.prototype = {
    ...
    onimg: function(json, event) {
        if (!document.getElementById("simg"))
        {
            ...
            '<div align="right" style="width:100%;height:20px;background:#fbfbfb"><span onclick="var cdiv=document.getElementById(\'simg\');cdiv.parentNode.removeChild(cdiv);" style="font-family:Arial;font-size:14px;color:#000000;cursor:pointer"><img style="margin-top:2px;margin-right:4px;" border="0" src="'+rooturl+'/Public/images/close.jpg"></span></div>' + 
            ...
            '<input type="file" name="file" style="width:300px;height:24px;"><span style="text-align:center;margin-left:10px;width:42px;height:24px;font-size:13px;line-height:28px;background:#4184ca;color:#fff;display:inline-block;cursor:pointer;" onclick="formlocalimg.submit()">上传</span><br>' + 
            '<iframe name="file_frame" style="display:none;"></iframe>' + 
            '</form>' + 
            '<label style="font-size:14px;margin-bottom:10px;display: block;">网络图片地址</label>' + 
            '<input type="text" id="onlineimg" placeholder="请输入正确的图片格式" style="border:1px solid #d8d8d8;-webkit-border-radius:6px;border-radius:6px;outline:none;width:300px;height:24px;"><span style="text-align:center;width:42px;height:24px;font-size:13px;line-height:28px;background:#4184ca;color:#fff;display:inline-block;cursor:pointer;position:relative;left:10px;" onclick="global_web_editor_obj.ononlineimg(document.getElementById(\'onlineimg\').value)">插入</span>' + 
            '</div>' + 
            '</div>';
    ...
    onurl:function(event){
    	if (!document.getElementById("ssurl"))
        {
            ...
            mydiv.style.zIndex = "100";
            mydiv.innerHTML = '<div>' + 
            '<div align="right" style="width:100%;height:20px;background:#fbfbfb"><span onclick="var cdiv=document.getElementById(\'ssurl\');cdiv.parentNode.removeChild(cdiv);" style="font-family:Arial;font-size:14px;color:#000000;cursor:pointer"><img style="margin-top:2px;margin-right:4px;" border="0" src="'+rooturl+'/Public/images/close.jpg"></span></div>' + 
            '<label style="font-size:14px;margin-bottom:10px;display: block;">添加超链接</label>' + 
            ...
            '<span style="text-align:center;width:42px;height:24px;font-size:13px;line-height:28px;background:#4184ca;color:#fff;display:inline-block;cursor:pointer;position:relative;left:10px;" onclick="global_web_editor_obj.onurldeal({url:document.getElementById(\'onlineurl\').value})">插入</span>' + 
            '</div>';
            document.body.appendChild(mydiv);
        }
    },
    ...
    onmusic:function(event){
    	if (!document.getElementById("smusic"))
        {
            ...
            mydiv.style.zIndex = "100";
            mydiv.innerHTML = '<div>' + 
            '<div align="right" style="width:100%;height:20px;background:#fbfbfb"><span onclick="var cdiv=document.getElementById(\'smusic\');cdiv.parentNode.removeChild(cdiv);" style="font-family:Arial;font-size:14px;color:#000000;cursor:pointer"><img style="margin-top:2px;margin-right:4px;" border="0" src="'+rooturl+'/Public/images/close.jpg"></span></div>' + 
            '<label style="font-size:14px;margin-bottom:10px;display: block;">网络音频地址</label>' + 
            ...
            '<span style="text-align:center;width:42px;height:24px;font-size:13px;line-height:28px;background:#4184ca;color:#fff;display:inline-block;cursor:pointer;position:relative;left:10px;" onclick="global_web_editor_obj.onmusicdeal({url:document.getElementById(\'onlinemusic\').value})">插入</span>' + 
            '</div>';
            document.body.appendChild(mydiv);
        }
    },
...
*/
    ...
    onflash:function(event) {
    	if (!document.getElementById("sflash"))
        {
            ...
            mydiv.style.zIndex = "100";
            mydiv.innerHTML = '<div>' + 
            '<div align="right" style="width:100%;height:20px;background:#fbfbfb"><span onclick="var cdiv=document.getElementById(\'sflash\');cdiv.parentNode.removeChild(cdiv);" style="font-family:Arial;font-size:14px;color:#000000;cursor:pointer"><img style="margin-top:2px;margin-right:4px;" border="0" src="'+rooturl+'/Public/images/close.jpg"></span></div>' + 
            '<label style="font-size:14px;margin-bottom:10px;display: block;">网络视频地址</label>' + 
            '<input type="text" id="onlineflash" placeholder="请输入正确的swf格式" style="border:1px solid #d8d8d8;-webkit-border-radius:6px;border-radius:6px;outline:none;width:200px;height:24px;">'+
            ...
            '<span style="text-align:center;width:42px;height:24px;font-size:13px;line-height:28px;background:#4184ca;color:#fff;display:inline-block;cursor:pointer;position:relative;left:10px;" onclick="global_web_editor_obj.onflashdeal({url:document.getElementById(\'onlineflash\').value,w:document.getElementById(\'onlineflashwidth\').value,h:document.getElementById(\'onlineflashheight\').value})">插入</span>' + 
            '</div>';
            document.body.appendChild(mydiv);
        }
    },
    ...
    onabout: function(event) {
        if (!document.getElementById("sabout"))
        {
            ...
            "<tr >" + 
            "<td  height=16 valign=top style=\"text-align:right;background:#fbfbfb\"><span onclick=\"var cdiv = document.getElementById('sabout');cdiv.parentNode.removeChild(cdiv);\" style=\"font-family:Arial;font-size:14px;color:#000000;cursor:pointer\"><img style=\"margin-top:2px;margin-right:4px;\" border=\"0\" src=\""+rooturl+"/Public/images/close.jpg\"></span></td>" + 
            "</tr >" + 
            "<tr >" + 
            "<td style=\"font-size:12px;font-weight:bold;line-height:20px;\" valign=top align=left>名称：web-editor<br>用途：JavaScript社区编辑器<br>作者：YouYaX<br>描述：一款自主开发设计的UBB前端编辑器</td>" + 
            "</tr></table>";
            document.body.appendChild(mydiv);
        }
    },
    colordiv: function(event) {
        if (!document.getElementById("scolor"))
        {
            ...
            mydiv.style.backgroundColor = "#ffffff";
            mydiv.style.zIndex = "99";
            mydiv.innerHTML = "<table cellspacing=0 cellpadding=0 border=0 style=\"border-collapse:separate;\">" + 
            "<tr >" + 
            "<td colspan=8  style=\"text-align:right;background:#fbfbfb\"><span onclick=\"var cdiv = document.getElementById('scolor');cdiv.parentNode.removeChild(cdiv);\" style=\"font-family:Arial;font-size:14px;color:#000000;cursor:pointer\"><img style=\"margin-top:2px;margin-right:4px;\" border=\"0\" src=\""+rooturl+"/Public/images/close.jpg\"></span></td>" + 
            "</tr >" + 
            "<tr>" + 
    ...
    codediv: function(json, event) {
    	if (!document.getElementById("scode"))
        {
            ...
            '<div align="right" style="width:100%;height:20px;background:#fbfbfb"><span onclick="var cdiv=document.getElementById(\'scode\');cdiv.parentNode.removeChild(cdiv);" style="font-family:Arial;font-size:14px;color:#000000;cursor:pointer"><img style="margin-top:2px;margin-right:4px;" border="0" src="'+rooturl+'/Public/images/close.jpg"></span></div>' + 
            '<div style="width:100%;height:100px;">' + 
            '<label style="font-size:14px;margin-bottom: 20px;display: block;">选择你要显示高亮的代码类型</label>' +  
            '<select id="codesel" style="width:100px;"><option value="">请选择类型</option><option value="html">HTML</option><option value="js">JavaScript</option><option value="php">PHP</option><option value="sql">SQL</option></select><span style="text-align:center;margin-left:10px;width:42px;height:24px;font-size:13px;line-height:28px;background:#4184ca;color:#fff;display:inline-block;cursor:pointer;" onclick="global_web_editor_obj.oncode(document.getElementById(\'codesel\').value)">确定</span>' + 
            '</div>' + 
            '</div>';
    ...
    facediv: function(json, event) {
        if (!document.getElementById("sface"))
        {
            ...
            "<tr>" + 
            "<td colspan=8 style=\"text-align:right;background:#fbfbfb\"><span onclick=\"var cdiv = document.getElementById('sface');cdiv.parentNode.removeChild(cdiv);\" style=\"font-family:Arial;font-size:14px;color:#000000;cursor:pointer\"><img style=\"margin-top:2px;margin-right:4px;\" border=\"0\" src=\""+rooturl+"/Public/images/close.jpg\"></span></td>" + 
            "</tr>" + 
            "<tr>" + 
