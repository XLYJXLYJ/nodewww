...
class Fenye_comments
{
	...
	function  show()
	{
		...
		{
			 $array=array();
			 array_push($array,"<a style='color:#1d53bf' href='".$this->geturl().$id."_".$id2."_1"."#p".$num."'>首</a>");	
		 	 for($i=1;$i<=$this->comments_count;$i++)
		 	 {	
  				 array_push($array,"<a class=comments".$id."_".$id2."_".$i." style='color:#1d53bf' href='".$this->geturl().$id."_".$id2."_".$i."#p".$num."'>$i</a>");
			 }
  			array_push($array,"<a style='color:#1d53bf' href='".$this->geturl().$id."_".$id2."_".$this->comments_count."#p".$num."'>末</a>");
  			return $array;
		}
		else
		{
